...
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { Key, Sun, Moon, Monitor, Trash2 } from 'lucide-react';
...
const Settings = () => {
  ...
  return (
    <div className="p-6 space-y-6 bg-white dark:bg-gray-900 min-h-screen">
      ...
      {activeTab === 'system' && (
        <>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">⚙️ System</h1>
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardHeader>
              <CardTitle className="text-gray-900 dark:text-white">System Settings</CardTitle>
              <CardDescription className="text-gray-600 dark:text-gray-400">
                Manage system data and preferences
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="border border-red-200 dark:border-red-800 rounded-lg p-4">
                <Label className="text-red-600 dark:text-red-400 font-medium">Clear All Data</Label>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-3">
                  This will remove all stored data including login session, preferences, and cached data. You will need to log in again.
                </p>
                <Button 
                  onClick={() => {
